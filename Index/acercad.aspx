<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="acercad.aspx.cs" Inherits="Proyect_2._0._1.Index.acercad" %>
...
<body data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
    ...
    <form id="form1" runat="server">
        ...
        <div class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="../user/principal.aspx">Majumi</a>
            <button class="navbar-toggler" data-toggle="collapse" data-target="#navbarSupportedContent1">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse" id="navbarSupportedContent1">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active"><a class="nav-link" href="../user/venta.aspx">Ventas <span class="sr-only">(current)</span></a> </li>
                    <li class="nav-item active"><a class="nav-link" href="../user/clientes.aspx">Clientes <span class="sr-only">(current)</span></a> </li>
                    <li class="nav-item active"><a class="nav-link" href="../user/usuarios.aspx">Usuarios <span class="sr-only">(current)</span></a> </li>
                    <li class="nav-item active"><a class="nav-link" href="../user/almacen.aspx">Almacen <span class="sr-only">(current)</span></a> </li>
                    <li class="nav-item active"><a class="nav-link" href="acercad.aspx">Acerca de<span class="sr-only">(current)</span></a> </li>
                </ul>
